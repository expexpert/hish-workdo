                ...
                <div class="col-xl-9">
                    ...
                    <div class="card" id="useradd-7">
                        ...
                        <div
                            ...
                            <input type="submit"  class="btn-submit btn btn-primary" value="{{ __('Save Changes') }}" class="btn btn-primary">
                        </div>
                        {{ Form::close() }}
                    </div>
                    ...
                    <div id="useradd-8" class="card">
                        ...
                        <div class="card-footer text-end">
                            <a href="{{ url('config-cache') }}"
                                class="btn btn-print-invoice btn-primary">{{ __('Clear Cache') }}</a>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    {{ Form::Select('chatgpt_model_name',$modal,  isset($settings['chatgpt_model_name']) ? $settings['chatgpt_model_name'] : '', ['class' => 'form-control', 'placeholder' => __('Select Chatgpt Model Name')]) }}
                                </div>
                            </div>
                        </div>
                        <div class="card-footer text-end">
