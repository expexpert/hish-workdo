                    ...
                    <div class="checkout-panel">
                        ...
                        <form id="checkout-form" action="{{ route('mobile.customer.store') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="full_name" required class="form-input" placeholder="Votre nom complet" value="{{ old('full_name') }}">
                            </div>
                            <div class="form-group">
                                <label class="form-label">Email</label>
                                <input type="email" name="email" required class="form-input" placeholder="votre@email.com" value="{{ old('email') }}">
                            </div>
                            <div class="form-group">
                                <label class="form-label">Téléphone</label>
                                <input type="tel" name="phone" required class="form-input" placeholder="+212 6 00 00 00 00" value="{{ old('phone') }}">
                            </div>
                            <div class="form-group">
                        ...
                        <div class="summary-details">
                            ...
                            <div class="summary-row">
                                <span class="summary-label">Facturation:</span>
                                <span class="summary-value" id="summary-billing">Mensuel</span>
                            </div>
                            <div class="summary-row">
                                <span class="summary-label">Prix:</span>
                                <span class="summary-value" id="summary-original">—</span>
                            </div>
                            @if(!empty($referralCode) && !empty($referralDiscount))
                            <div class="summary-row discount" id="referral-row">
                                <span class="summary-label">Réduction {{ strtoupper($referralCode) }}:</span>
                        ...
                        <div class="renewal-info">
                            <p class="renewal-text" id="renewal-text">Sélectionnez un plan pour continuer.</p>
                        ...
                        <div class="trust-indicators">
                            <div class="trust-item"><span class="trust-icon">🔒</span> <span>Paiement sécurisé</span></div>
                            <div class="trust-item"><span class="trust-icon">⏰</span> <span>Annulez à tout moment</span></div>
                            <div class="trust-item"><span class="trust-icon">✓</span> <span>Garantie 7 jours</span></div>
                            <div class="trust-item"><span class="trust-icon">⚡</span> <span>Accès instantané</span></div>
                        </div>
                    </div>
                </div>
            </div>
