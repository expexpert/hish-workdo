...
<div class="d-flex">
    ...
    <button class="btn btn-sm btn-primary me-2" data-bs-toggle="modal" data-bs-target="#invite-customers"><i class="ti ti-mail-forward"></i></button>
    @endif
...
<div class="modal fade" id="invite-customers" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content w-75 mx-auto">
            <form method="POST" action="{{ route('invite.customer') }}" enctype="multipart/form-data">
                @csrf
                <div class="modal-header">
                    <h5 class="modal-title">{{ __('Send Invitation to Customer') }}</h5>
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <small class="text-muted">{{ __('Enter the email addresses of the customers you want to invite.') }}</small>
                    </div>
                </div>
