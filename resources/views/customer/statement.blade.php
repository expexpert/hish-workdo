                            ...
                            <span id="printableArea">
                                ...
                                <div class="row">
                                    ...
                                    @php
                                        ...
                                        // Create array mapping invoice_id to total for payments
                                        foreach ($invoice_payment as $payment) {
                                            $invoice = $invoice_total->where('id', $payment->invoice_id)->first();
                                            if ($invoice) {
                                                $invoiceTotals[$payment->invoice_id] = $invoice->getTotal();
                                            }
                                        }

                                        // Calculate total invoiced amount only for invoices with payments
                                                ...
                                                <tbody class="list">
                                                    ...
                                                    @forelse($invoice_payment as $payment)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                @if(isset($invoiceTotals[$payment->invoice_id]))
                                                                    {{ \Auth::user()->priceFormat($invoiceTotals[$payment->invoice_id]) }}
                                                                @else
