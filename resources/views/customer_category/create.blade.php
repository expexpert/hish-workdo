{{ Form::open(['url' => 'customer-category','class'=>'needs-validation','novalidate']) }}
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-12 d-block">
            ...
            {{ Form::textarea('description', '', ['class' => 'form-control', 'required' => 'required', 'placeholder'=>__('Enter Category Description'), 'rows' => 3]) }}
        </div>
